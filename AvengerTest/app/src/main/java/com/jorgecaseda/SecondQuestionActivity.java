...
public class SecondQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonNextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (radioGroup.getCheckedRadioButtonId() == -1){
                    Toast.makeText(SecondQuestionActivity.this, "Choose an option!", Toast.LENGTH_LONG).show();
                }
                else{
        ...
        buttonPreviousQuestion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SecondQuestionActivity.this, FirstQuestionActivity.class);
                startActivity(intent);
            }
        });
    }
